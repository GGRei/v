...
$greenProductionSurface = @(
    ...
    [pscustomobject]@{ Path = 'vlib/x/multiwindow/win32_backend_helpers.h'; Known = 'ac6bc4bd9ed504b200471fb2688a8215777ac26b267c6bbcbb2b7b37330dd765'; Passed = $ExpectedWin32BackendHelpersSha256 }
...
$knownGreenProductionSurfaceSha256 = '09b0b7cd12bca3045372b415230cbe0f011b95291b5d520978213ada8d3b0add'
