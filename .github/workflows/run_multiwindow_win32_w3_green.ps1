...
$surface = @(
    [pscustomobject]@{
		...
		Hash = '27ecd8d02916286bc08ddeebbf9757b0a8e8499872e394fe32c0221969d96f3c'
    }
    [pscustomobject]@{
...
$knownCompositeSha256 = 'cb61cfc2d2210f392722463e05d0b340cf8578d78bb2bfb5d65a020e6b9d64ce'
