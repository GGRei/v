...
fn win32_red_dpi_creation_fallback_case(context_mode int) ! {
	$if windows {
		...
		assert C.v_multiwindow_win32_test_dpi_context_attempt_count() == 2
		assert C.v_multiwindow_win32_test_dpi_context_fallback_count() == 2
		assert C.v_multiwindow_win32_test_dpi_exact_resize_count() >= 3
