...
int main(void) {
	...
	fprintf(stderr,
		"PACKAGE2_W5_INFRA=stage:%u error:%u proof:%u cleanup:%u cleanup_error:%u desktop_mask:%u desktop_streak:%u desktop_snapshot_flags:%u desktop_current_flags:%u\n",
...
int main(void) {
	...
	fprintf(stderr, "PACKAGE2_W5_A0_FAMILY=raw_input_environment\n");
	fprintf(stderr,
		"PACKAGE2_W5_INFRA=stage:2 error:50 proof:0 cleanup:255 cleanup_error:0 desktop_mask:0 desktop_streak:0 desktop_snapshot_flags:0 desktop_current_flags:0\n");
	fprintf(stderr,
		"PACKAGE2_W5_A0_TERMINAL=infra:raw_input_environment\n");
	fflush(stderr);
	return 1;
