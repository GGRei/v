...
fn (mut app App) run_accepted_managed(config RunConfig, has_app_frame bool, has_window_frames bool, has_events bool, has_input bool, has_app_resources bool) ! {
	needs_render := has_app_frame || has_window_frames || has_app_resources
	...
	for app.core.status() == .running {
		...
		if needs_render && !render_initialized {
