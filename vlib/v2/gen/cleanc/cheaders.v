...
fn (mut g Gen) collect_directives_from_active_comptime_if(expr ast.IfExpr, file_name string, emit_implementation_directives bool, mut seen map[string]bool) {
	...
	if expr.else_expr is ast.IfExpr {
		if expr.else_expr.cond is ast.EmptyExpr {
			g.collect_directives_from_stmts(expr.else_expr.stmts, file_name,
				emit_implementation_directives, mut seen)
		} else {
		...
		g.collect_directives_from_expr(expr.else_expr, file_name, emit_implementation_directives, mut
			seen)
	}
}
