...
fn (mut g FlatGen) prepare_parallel_node(id flat.NodeId) {
	...
	if idx >= 0 && idx < g.tc.expr_type_set.len && g.tc.expr_type_set[idx] {
		expr_type := g.tc.expr_type_values[idx]
...
fn (mut g FlatGen) preseed_parallel_fn_ptr_type(typ types.Type) {
	if typ is types.FnType {
		g.resolve_fn_ptr_type(g.fn_ptr_type_key(typ, []bool{}))
...
fn (g &FlatGen) clone_parallel_type_checker() &types.TypeChecker {
	...
	return &types.TypeChecker{
		...
		fn_const_ptr_param_masks:                 g.tc.fn_const_ptr_param_masks.clone()
		type_alias_fn_const_ptr_param_masks:      g.tc.type_alias_fn_const_ptr_param_masks.clone()
		fn_variadic:                              g.tc.fn_variadic.clone()
		generic_fn_templates:                     g.tc.generic_fn_templates.clone()
		disabled_conditional_void_fn_param_types: g.tc.disabled_conditional_void_fn_param_types.clone()
		disabled_conditional_void_fn_variadic:    g.tc.disabled_conditional_void_fn_variadic.clone()
		disabled_conditional_nonvoid_fns:         g.tc.disabled_conditional_nonvoid_fns.clone()
		structs:                                  g.tc.structs.clone()
		unions:                                   g.tc.unions.clone()
		params_structs:                           g.tc.params_structs.clone()
		...
		resolved_call_names:                      g.tc.resolved_call_names.clone()
			...
			resolved_fn_value_names:                  g.tc.resolved_fn_value_names.clone()
			resolved_fn_value_set:                    g.tc.resolved_fn_value_set.clone()
			fn_value_userdata_wrapper_set:            g.tc.fn_value_userdata_wrapper_set.clone()
		struct_field_fn_const_ptr_param_masks:    g.tc.struct_field_fn_const_ptr_param_masks.clone()
		expr_fn_const_ptr_param_masks:            g.tc.expr_fn_const_ptr_param_masks.clone()
		disabled_conditional_call_set:            g.tc.disabled_conditional_call_set.clone()
		imported_type_constructor_call_set:       g.tc.imported_type_constructor_call_set.clone()
