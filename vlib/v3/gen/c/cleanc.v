...
fn (mut g FlatGen) headerless_libc_preamble() {
	...
	g.writeln('#if defined(_WIN32) || defined(_WIN64)')
	g.writeln('#define _IOLBF 0x0040')
	g.writeln('#else')
	...
	g.writeln('#if defined(_WIN32) || defined(_WIN64)')
	g.writeln('#define _IONBF 0x0004')
	g.writeln('#else')
	...
	g.writeln('#elif defined(__TINYC__) && (defined(_WIN32) || defined(_WIN64))')
	g.writeln('#ifndef _FILE_DEFINED')
	g.writeln('struct _iobuf {')
	g.writeln('\tchar *_ptr;')
	g.writeln('\tint _cnt;')
	g.writeln('\tchar *_base;')
	g.writeln('\tint _flag;')
	g.writeln('\tint _file;')
	g.writeln('\tint _charbuf;')
	g.writeln('\tint _bufsiz;')
	g.writeln('\tchar *_tmpfname;')
	g.writeln('};')
	g.writeln('typedef struct _iobuf FILE;')
	g.writeln('#define _FILE_DEFINED')
	g.writeln('#endif')
	g.writeln('#else')
	...
	g.writeln('#elif defined(__MINGW32__) || defined(__MINGW64__) || (defined(__clang__) && (defined(_WIN32) || defined(_WIN64)))')
	g.writeln('FILE* __cdecl __acrt_iob_func(unsigned index);')
	g.writeln('#define stdin  (__acrt_iob_func(0))')
	g.writeln('#define stdout (__acrt_iob_func(1))')
	g.writeln('#define stderr (__acrt_iob_func(2))')
	g.writeln('int* _errno(void);')
	g.writeln('#define errno (*_errno())')
	g.writeln('#elif defined(__TINYC__) && (defined(_WIN32) || defined(_WIN64))')
	g.writeln('#if defined(_WIN64)')
	g.writeln('FILE* __cdecl __iob_func(void);')
	g.writeln('#else')
	g.writeln('#ifdef _MSVCRT_')
	g.writeln('extern FILE _iob[];')
	g.writeln('#define __iob_func() (_iob)')
	g.writeln('#else')
	g.writeln('extern FILE (*_imp___iob)[];')
	g.writeln('#define __iob_func() (*_imp___iob)')
	g.writeln('#define _iob __iob_func()')
	g.writeln('#endif')
	g.writeln('#endif')
	g.writeln('#define stdin (&__iob_func()[0])')
	g.writeln('#define stdout (&__iob_func()[1])')
	g.writeln('#define stderr (&__iob_func()[2])')
	g.writeln('int* _errno(void);')
	g.writeln('#define errno (*_errno())')
