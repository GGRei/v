...
fn test_v3_cpp_linker_default_driver_follows_c_driver_family() {
	...
	assert v3_default_cpp_compiler('C:/msys64/ucrt64/bin/clang.exe') == 'C:/msys64/ucrt64/bin/clang++.exe'
	assert v3_default_cpp_compiler('/opt/llvm/bin/clang-22') == '/opt/llvm/bin/clang++-22'
