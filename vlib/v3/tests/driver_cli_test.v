...
')!
	...
	for iteration in 0 .. 2 {
		plain_output := if real_pairs.len > 0 {
			os.join_path(root, 'plain_${iteration}${if os.user_os() == 'windows' { '.exe' } else { '' }}')
		} else {
			os.join_path(root, 'plain_${iteration}.c')
		}
		...
		if real_pairs.len > 0 {
			...
			plain_baseline_output := os.join_path(root, 'plain_baseline_${iteration}.c')
