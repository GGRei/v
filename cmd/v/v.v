...
fn v3_has_v1_only_preferences(prefs &pref.Preferences) bool {
	...
	return prefs.sanitize || prefs.is_livemain || prefs.is_liveshared
		...
		|| (prefs.ldflags.len > 0 && (prefs.pkgconfig_mode != .static_ || prefs.is_fastc))
		|| prefs.nofloat || prefs.fast_math || prefs.compress || prefs.is_bare
		|| prefs.no_closures || prefs.disable_explicit_mutability
